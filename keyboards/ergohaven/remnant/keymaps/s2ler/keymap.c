...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [HOME_LAYER] = LAYOUT(
        LGUI(KC_TAB), XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, QK_BOOT,          QK_BOOT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, LSFT(KC_F13),
        KC_TAB,  MEH_T(KC_Q),  KC_W, KC_E,  KC_R, KC_T,                     KC_Y, KC_U, KC_I, KC_O, KC_P, OSL(7),
    ...
    [APP_LAYER] = LAYOUT(
        ...
        XXXXXXX, APP_PYCHARM, APP_BROWSER, XXXXXXX, ACT_SIRI, XXXXXXX,        ACT_PREV_DESKTOP, ACT_APPLICATION_WINDOWS, ACT_MISSION_CONTROL, ACT_NEXT_DESKTOP, XXXXXXX, XXXXXXX,
    ...
    [ACTION_LAYER] = LAYOUT(
        ...
        XXXXXXX, ACT_RAYCAST_AI, XXXXXXX, ACT_DICTATION, ACT_SEARCH_FILES, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    ...
    [NUM_LAYER] = LAYOUT(
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                       XXXXXXX,     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                       XXXXXXX,     KC_KP_7, KC_KP_8, KC_KP_9, KC_COMMA, KC_KP_PLUS,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                       KC_KP_COMMA, KC_KP_4, KC_KP_5, KC_KP_6, KC_0,     KC_KP_EQUAL,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                       KC_DOT,      KC_KP_1, KC_KP_2, KC_KP_3, KC_SLASH, XXXXXXX,
        XXXXXXX, XXXXXXX,                                                           _______, _______,
